...
ClrLoop  clr   ,x+			clear a byte       
	...
	IFGT	LEVEL-2
	ldq	>$0350			get F$SRqMem and F$SRtMem vectors
	stq	>$0670			save ‘em
	ENDC
...
* New F$SRqMem vector
*
L00D9    pshs  u,y,x,dp			save all regs         pshsw         pshs  b,a,cc         leau  ,s			point U to them         ldd   1,u                      ??? D already has size         addd  #$00FF			round it to nearest block         clrb         std   1,u			save it back         bsr   L0100L00EB    tfr   cc,a         bcc   L00F1         stb   2,sL00F1    sta   ,s         puls  b,a,cc         pulsw         puls  pc,u,y,x,dpL00F8    ldx   $0C,u         cmpx  #$6000         bhi   L010FL0100    ldx   #$2000			get base rbf/scf local mem pointer         leay  $40,x         leax  a,xL0108    ldb   1,u         cmpr  x,y         bhi   L0113L010F    jmp   [>$0670]			jump to original L2 F$SRqMemL0113    lda   ,-y         bne   L0108         decb         bne   L0113         tfr   y,d         addr  b,a         clrb         std   $0a,u         ldb   1,u         lda   #$01L0126    sta   ,y+         decb           bne   L0126L012B    clrb           rts   L012D    comb           ldb   #$D2         rts   *
* New F$SRtnMem
*L0131    pshs  u,y,x,dp         pshsw          pshs  b,a,cc         leau  ,s         bsr   L013D         bra   L00EBL013D    ldd   $01,u         beq   L012B         addd  #$00FF         ldb   $0B,u         bne   L012D         ldb   $0A,u         cmpb  #$20         beq   L012D         cmpb  #$60         bcs   L0156         jmp   [>$0672]			jump to original F$SRtMemL0156    subb  #$20         ldx   #$2000         abx   srtlop    clr   ,x+         deca           bne   srtlop         clrb           rts	ENDC
